...
from .modules.layers import DoubleStreamPairedBlockLoraProcessor, SingleStreamPairedBlockLoraProcessor  
...
def prepare_prompt(prompt: str | list[str], t5: HFEmbedder, clip: HFEmbedder, bs: int = 1) -> dict[str, Tensor]:
    if bs == 1 and not isinstance(prompt, str):
        bs = len(prompt)
