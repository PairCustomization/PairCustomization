...
def scheduler_type_to_class(scheduler_type):
    if scheduler_type == Scheduler_Type.DDIM or scheduler_type == "DDIM":
        return MyDDIMScheduler
    elif scheduler_type == Scheduler_Type.EULER or scheduler_type == "EULER":
        return MyEulerAncestralDiscreteScheduler
    elif scheduler_type == Scheduler_Type.LCM or scheduler_type == "LCM":
...
def model_type_to_class(model_type):
    if model_type == Model_Type.SDXL or model_type == "SDXL":
